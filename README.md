...
&emsp; This entire project is published on GitHub.   The VB.NET solution for WeightLossTracker, the narrative describing how it was made, and WeightLossTrackerDBCreationScript.sql discussed herein can be found and downloaded at the following link:
...
&emsp; Software engineering is not always a one-person job.  Solutions are often developed by a team of engineers and stakeholders who must work cooperatively on the same code base.  To keep things organized and secure, I studied and practiced using Git.  Git is a popular distributed version control software package designed to allow teams to manage the evolution of their code.  CS-320 Software Testing & Automation taught me the process of creating code repositories where students were able to edit their specific parts of the same code file without interfering with each other’s work.  We used it to perform peer reviews of each other’s code giving feedback and making recommendations for later consideration.  This e-Portfolio is published on GitHub for others to view or modify the work that I’ve done.  This tool has proven invaluable with team collaboration and my skills continue to improve the more I use it.

The following two links are to my GitHub and BitBucket repositories where all my projects that I developed for SNHU are published.
...
&emsp; DAT-220 Introduction to SQL and CS-340 Advanced Programming Concepts taught basic and advanced database development with MySQL and MongoDB.  Over the course of my professional career, I have worked extensively with SQL Server databases so as an added challenge, I chose to use a fork of MySQL called MariaDB to build upon what I learned in the courses and my own experiences with SQL Server to convert the application from single-user to multi-user.  Over the years, I’ve come to realize that many businesses live and die by their data.  The systems that store that data require careful planning and management to maximize accessibility and security.  There are professionals that focus their proficiencies on only the front-end or back-end of application development, but I wanted instead to demonstrate skills with both.  Full-stack developers reduce costs by providing a single resource to handle more of the development.


### Security

&emsp; The average cost of a data breach in 2022 was a record 4.4 million dollars (Fowler, 2022).  This far exceeds the cost of designing security into software from the initial planning to the maintenance of the final release.  CS-405 Secure Coding course detailed the philosophy of Defense in Depth which is a unique layering of different security measures designed to adequately protect a given asset in each set of unique circumstances.  During that course, I designed a security policy and presentation video for a fictional business called Green Pace.  Many of those standards, principles, and best practices have been applied to this project with one or more enhancements made for each of the three categories and will be discussed as examples arise.
